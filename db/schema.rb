...
ActiveRecord::Schema.define(:version => 20130520202455) do
  ...
  create_table "refinery_products", :force => true do |t|
    ...
    t.string   "gosreestr_number"
    t.text     "usage"
    t.string   "si_identity"
    t.string   "m_interval"
    t.text     "complectation"
  end
  ...
  create_table "sessionorders", :force => true do |t|
    t.text     "order"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end

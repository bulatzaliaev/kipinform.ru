...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret = "66fd1dab3bc3797987c8eba2b10a80b7efdb502e358c94ad"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:format"
  # config.datastore_root_path = "/Users/isulimov/Documents/rails_apps/kippribor/public/system/refinery/resources"
